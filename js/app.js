// CampusConnect — prototype app logic + Supabase integration
...
async function loadProfile(user) {
  ...
  if (data && DATA.currentUser) {
    DATA.currentUser.name =
      data.name || user.email?.split("@")[0] || "Student";
...
function updateAuthButton() {
  ...
  if (!authBtn) {
    ...
    if (createBtn && createBtn.parentElement) {
      createBtn.parentElement.insertBefore(
        authBtn,
        createBtn
      );
    } else {
...
DATA.people.forEach((p) => {
  state.connectState[p.name] = "Connect";
});

DATA.communities.forEach((c) => {
  state.communityState[c.name] =
    c.role ? "Member" : "Join";
});
  ...
  return `
    <section class="view">
      ...
      <div class="view-head">
        ...
        <p class="eyebrow-free">
          Tuesday · your campus, at a glance
        </p>
  ...
  const list = DATA.people
    ...
    .map(
      ...
      <article class="person-card">
        ...
        <p class="person-match">
          ${p.match}
        </p>

        <button
          class="btn-outline btn-connect"
          data-name="${p.name}"
        >
          ${state.connectState[p.name]}
        </button>
  ...
  return `
    <section class="view">
      ...
      <div class="view-head">
        ...
        <p class="view-sub">
          Matched by skills, interests and what you're building —
          not follower counts.
        </p>
    ...
    .map(
      ...
      <article class="opp-card">
        ...
        <div class="opp-top">
          ...
          <span class="tag tag--${o.type.toLowerCase()}">
            ${o.type}
          </span>
    ...
    <section class="view">
      ...
      <div class="view-head">
        ...
        <p class="view-sub">
          ...
          opportunities matched to your skills and year.
        </p>

      </div>

      <div class="grid grid--opps">
        ...
        <article class="index-card">
          ...
          <div class="chip-row">
            ...
            ${p.stack
              .map(
                (s) =>
                  `<span class="chip chip--muted">${s}</span>`
              )
              .join("")}
          ...
          <div class="index-looking">
            ...
            <span class="index-looking-label">
              Looking for
            </span>
          ...
          <div class="index-foot">
            ...
            <span class="index-deadline">
              Deadline ${p.deadline}
            </span>

            <button
              class="btn-solid btn-join"
              data-name="${p.name}"
            >
              ${
                requested
  ...
  return `
    <section class="view">
      ...
      <div class="view-head">
        ...
        <p class="eyebrow-free">
          Projects & teammate matching
        </p>

        <h1 class="view-title">
          Build something with campus talent
        </h1>
      ...
      return `
        <article class="community-card">
          ...
          <div class="community-top">
            ...
            <span class="tag tag--${c.category.toLowerCase()}">
              ${c.category}
            </span>
          ...
          <button
            class="btn-outline btn-join-community"
            data-name="${c.name}"
            ${
              status === "Member"
                ? "disabled"
        ...
        <div class="profile-block profile-block--wide">
          ...
          <div class="chip-row">
            ...
            ${u.badges
              .map(
                (b) =>
                  `<span class="chip chip--badge">${b}</span>`
              )
              .join("")}
...
function bindDynamicButtons() {
  ...
  root
    .querySelectorAll(".btn-join-community")
    .forEach((btn) => {
...
const POST_TYPES = [
  {
    key: "general",
    label: "General post",
    hint: "Share an update, photo or thought"
  },
  {
    key: "question",
    label: "Question",
    hint: "Ask the campus something"
  },
  {
    key: "opportunity",
    label: "Opportunity",
    hint: "Internship, hackathon, competition"
  },
  {
    key: "project",
    label: "Project",
    hint: "Looking for collaborators"
  },
  {
    key: "achievement",
    label: "Achievement",
    hint: "A win, certification or publication"
  },
  {
    key: "poll",
    label: "Poll",
    hint: "Ask students to vote"
  }
];
  ...
  createButton.addEventListener(
    ...
    () => {
      ...
      box.innerHTML = `
        ...
        <p class="modal-sub">
          What do you want to share with your campus?
        </p>
          ...
          option.addEventListener(
            ...
            () => {
              ...
              box.innerHTML = `
                ...
                <p class="modal-sub">
                  This is a prototype —
                  posting isn't wired up to a backend yet.
                </p>
